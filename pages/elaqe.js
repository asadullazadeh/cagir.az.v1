    ...
    <div>
      ...
      <div className="flex flex-col items-center min-h-screen pt-[50px] md:pt-0 md:justify-center">
        <div className="flex flex-col items-center w-full">
          ...
          <Contact_Part />
          <p className="font-medium lg:font-semibold text-[12px] lg:text-[18px] leading-[18px] lg:leading-[34px] text-[#959595] py-[40px]">Hər hansı şikayət və təklifiniz olarsa, bizimlə əlaqə saxlaya bilərsiniz.</p>
        {/* team part */}
