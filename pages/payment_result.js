  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="flex flex-col  p-[15px] lg:py-[20px] lg:px-[30px] xl:py-[25px] xl:px-[40px] 2xl:py-[30px] 2xl:px-[50px] border rounded-[20px] shadow-[0_4px_16px_rgba(32, 32, 32, 0.15)]">
        ...
        {/* ad ve email */}
        <div className="flex flex-col">
            <p className="font-semibold text-[12px] leading-[18px]">Tağı Əsədullazadə</p>
            <p className="font-medium text-[10px] text-cagiraz leading-[15px] ">tagi.asadullazadeh@gmail.com</p>
        </div>
      </div>
      {/* button part */}
