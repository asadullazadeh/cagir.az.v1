      ...
      <div className="flex flex-col pb-[50px] pt-[30px] md:pb-[60px] lg:pb-[70px] xl:pb-[80px] 2xl:pb-[90px]">
        ...
        <div className="flex flex-col font-semibold  gap-y-[15px] pb-[30px] lg:pb-[90px] text-gray900">
          <p className="text-[12px] lg:text-[18px] leading-[22px] lg:leading-[34px]">
            ...
            məişət xidmətlərini tapıb olduğunuz məkana çağırmağa imkan yaradan
            bir platformadır. Cagir.az vasitəsilə biz qeyri müəyyənliyi aradan
          ...
          <ol className="list-decimal text-[12px] lg:text-[18px] leading-[22px] lg:leading-[34px] px-[20px] lg:px-[60px]">
            ...
            <li>
              Niyə ahıl və ya fiziki məhdudiyyətli insanımız bərbər, tibbi
              xidmət və ya digər mövzularda əziyyət çəkir?
            </li>
            <li>
              Niyə evimizdə məişət ustasına ehtiyac duyarkən daha öncədən
              qiyməti bilə bilmir və hər zaman özümüzü narahat hiss edirik?
            </li>
            <li>
