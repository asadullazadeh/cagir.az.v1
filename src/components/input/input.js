      ...
      <div className="inline-flex flex-col w-full">
        ...
        >
          ...
          <input
            ...
            id="inpt"
            name="inpt"
            className="w-full font-semibold text-[10px] leading-[15px] text-black500 bg-white focus:outline-none focus:ring focus:ring-white border-none p-0 lg:hidden bg-white"
