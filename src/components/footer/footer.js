...
// const Footer = () => (
//   <>
//     <footer className="lg:px-[60px] lg:pt-[80px] lg:pb-[90px] h-full bg-white200 mt-[135px]">
//       <div className="grid list-none grid-cols-1 lg:grid-cols-4">
//         {/* 1st column-Cagir.az */}
...
//             <li className="flex justify-start space-x-[25px]">
//               {/* Insta icon */}
...
//                 </div>
//                 <div>
//                   <p className="font-semibold text-[14px] leading-[21px] text-gray900">
...
//         {/* 2nd column-Faydali kecidler */}
//         <div className="order-2 lg:order-1">
//           {/* 2nd column:title */}
//           <h2 className="mb-[15px] font-extrabold text-[18px] text-black500 leading-[27px]">
//             Faydalı keçidlər
//           </h2>
//           <ul className="space-y-[15px] font-semibold text-[14px] leading-[21px] inline-block min-w-max">
//             {/* 2nd column:1st */}
