...
const Badge = () => (
    <div>
        <div className="hidden lg:flex lg:gap-x-[137px] xl:gap-x-[164px] 2xl:gap-x-[190px] justify-center">
        ...
        <div className="flex lg:hidden gap-x-[55px] sm:gap-x-[83px] md:gap-x-[110px] justify-center">
            <div className="flex flex-col items-center">
