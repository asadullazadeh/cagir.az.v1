  ...
  return (
    <div className="flex flex-col gap-y-[5px]">
      <p className="hidden lg:block font-semibold text-[12px] leading-[18px] text-black500">
        ...
        <div
          className={`flex flex-row justify-between items-center px-[15px] py-[15px] lg:px-[15px] lg:py-[12.5px] border ${
        ...
        >
          ...
          />
          <button
                className="hidden lg:block font-extrabold text-cagiraz text-[14px] leading-[21px]"
              >
                Xəritə
              </button>
